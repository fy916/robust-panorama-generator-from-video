...
from alg3_sky_renderer import synrain
import os
...
class SkyBox():
    ...
    def load_skybox(self):
        ...
        if '.jpg' or 'JPG' or 'jpeg' in self.args.skybox:
            # static backgroud
            skybox_img = cv2.imread(os.path.join(r'./alg3_sky_renderer/skybox', self.args.skybox), cv2.IMREAD_COLOR)
            ...
            # video backgroud
            cap = cv2.VideoCapture(os.path.join(r'./alg3_sky_renderer/skybox', self.args.skybox))
