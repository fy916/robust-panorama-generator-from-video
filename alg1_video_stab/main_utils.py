...
def process_max_frames_arg(max_frames_arg):
    """Handle maxFrames arg in alg1_video_stab.__main__

    Convert negative values to inf

    :param max_frames_arg: maxFrames arg in alg1_video_stab.__main__
...
def process_layer_frames_arg(layer_frames_arg):
    """Handle layerFrames arg in alg1_video_stab.__main__

    :param layer_frames_arg: layerFrames arg in alg1_video_stab.__main__
    :return: alg1_video_stab.layer_overlay if True else None
...
def process_border_size_arg(border_size_arg):
    """Handle borderSize arg in alg1_video_stab.__main__

    Convert strings that aren't 'auto' to 0

    :param border_size_arg: borderSize arg in alg1_video_stab.__main__
    :return: int or 'auto'
...
def cli_stabilizer(args):
    """Handle CLI alg1_video_stab processing

    :param args: result of vars(ap.parse_args()) from alg1_video_stab.__main__
    :return: None
    """
