...
def auto_border_start(min_corner_point, border_size):
    ...
    :param border_size: min border_size determined by extreme_frame_corners in alg1_video_stab process
...
def auto_border_crop(frame, extreme_frame_corners, border_size):
    """Crop frame for auto border in alg1_video_stab process

    :param frame: frame to be cropped
    :param extreme_frame_corners: extreme_frame_corners attribute of alg1_video_stab object
    :param border_size: min border_size determined by extreme_frame_corners in alg1_video_stab process
