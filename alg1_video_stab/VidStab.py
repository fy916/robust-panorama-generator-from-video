...
safe_import_cv2()  # inform user of pip install alg1_video_stab[cv2] if ModuleNotFoundError
...
class VidStab:
    ...
    def _apply_transforms(self, output_path, max_frames, use_stored_transforms,
        ...
        while True:
            ...
            total_frames.append(transformed)
        self.writer.release()
        self.writer = None
    ...
    def gen_transforms(self, input_path, smoothing_window=30, show_progress=True, oursourceFrames = None):
        ...
        self.frame_queue.set_frame_source(cv2.VideoCapture(input_path), oursourceFrames = oursourceFrames)
    ...
    def stabilize(self, input_path, output_path, smoothing_window=30, max_frames=float('inf'),
                  ...
                  output_fps=None, oursourceFrames = None):
        ...
        return self._apply_transforms(output_path, max_frames, use_stored_transforms=use_stored_transforms,
