...
# project
from alg2_low_light_A.exposure_enhancement import enhance_image_exposure

# set the configuration to run the alg2_low_light_A.
def run_lowlight_A(frame, lime = True):
    print("Running low light enhancement using lime method. Please note that this process can be very slow (more than ten minutes).")
    ...
    frames = [frame]
    parser.add_argument("-f", '--folder', default="workfolder", type=str,
    ...
    parser.add_argument("-ul", "--lime", default=lime,
